...
answers = {
    ...
    "Software": Answer("Ein Software Problem? Welche der folgenden Dinge trifft zu?", ["Programm abgestürzt", "Update Problem", "Bug", "Programm ist langsam", "Anderes"]),
        ...
        "Update Problem": Answer("Haben Sie versucht das Programm oder Ihren Rechner neuzustarten?" , ["Funktioniert wieder", "Update hängt immer noch"]),
            "Update hängt immer noch": Answer("Ich rate Ihnen das Sie unser Support-Team kontaktieren." , end_options_default),
        "Bug": Answer("Haben Sie versucht das Programm oder Ihren Rechner neuzustarten?" , ["Funktioniert wieder", "Bug bleibt bestehen"]),
            "Bug bleibt bestehen": Answer("Ich rate Ihnen das Sie unser Support-Team kontaktieren." , end_options_default),
        "Programm ist langsam": Answer("Haben Sie versucht das Programm oder Ihren Rechner neuzustarten?" , ["Funktioniert wieder", "Programm bleibt langsam"]),
            "Programm bleibt langsam": Answer("Liegt ein Update für das Programm vor?" , ["Funktioniert wieder", "Funktioniert nicht"]),
                "Funktioniert nicht": Answer("Ich rate Ihnen das Sie unser Support-Team kontaktieren." , end_options_default),
    ...
    "Hardware": Answer("Ein Hardware Problem? Welche der folgenden Dinge trifft zu?", ["Computerabsturz", "Serverabsturz", "Druckerproblem", "Physische Schaeden", "Anderes"]),
        ...
        "Druckerproblem": Answer("Gibt der Drucker einen Fehlercode an oder leuchtet er in einer bestimmten Weise?", ["Ja der Drucker macht etwas", "Nein der Drucker macht nichts"]), 
            "Ja der Drucker macht etwas": Answer("Ich rate Ihnen das Sie unser Support-Team kontaktieren.", end_options_default),
            "Nein, der Drucker macht nichts": Answer("Taucht das Gerät im Geräte-Manager auf? Wenn ja trennen Sie den Drucker 10-15 Minuten vom Strom", ["Druckerproblem bleibt bestehen", "Funktioniert wieder"]), 
                "Druckerproblem bleibt bestehen": Answer("Ich rate Ihnen das Sie unser Support-Team kontaktieren.", end_options_default),                                                                                            
        "Physische Schaeden": Answer("Ich rate Ihnen das Sie unser Support Team kontaktieren.", end_options_default),
    ...
    "Netzwerk": Answer("Ein Netzwerk Problem? Welche der folgenden Dinge trifft zu?", ["Webseiten Probleme", "Verbindungsprobleme", "Anderes"]),
        "Webseiten Probleme": Answer("Können sie sicherstellen das Ihre Internet Verbindung besteht?", ["Verbindung steht", "Verbindung steht nicht"]),
            "Verbindung steht nicht": Answer("Ich rate Ihnen das Sie unser Support-Team kontaktieren.", end_options_default),                                                                                                  
            "Verbindung steht": Answer("Sind auch andere Webseiten betroffen?", ["Ja, auch andere", "Nein, keine anderen"]),                                                                                                
                "Ja, auch andere": Answer("Ich rate Ihnen das Sie unser Support-Team kontaktieren.", end_options_default),
                "Nein, keine anderen" : Answer("Ist die Webseite eine interne Ihrer Firma oder die einer externen?", ["Intern", "Extern"]),
                    ...
                    "Intern": Answer("Ich rate Ihnen das Sie unser Support-Team kontaktieren.", end_options_default),                                                                                         
